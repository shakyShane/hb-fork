...
var __module13__ = (function(__dependency1__, __dependency2__) {
  ...
  Compiler.prototype = {
    ...
    MustacheStatement: function(mustache) {
      ...
      /**
       * Give all helpers access to initial start point
       * of tag
       * @private
       */
      mustache.sexpr._crossbow = {
        column: mustache.loc.start.column,
    ...
    ambiguousSexpr: function(sexpr, program, inverse) {
      ...
      this.opcode('invokeAmbiguous', name, isBlock, sexpr);
    },
    ...
    helperSexpr: function(sexpr, program, inverse) {
      ...
      if (this.options.knownHelpers[name]) {
        ...
        this.accept(path);
        this.opcode('invokeHelper', params.length, path.original, simpleId(path), sexpr);
      }
    },
...
var __module14__ = (function(__dependency1__, __dependency2__, __dependency3__, __dependency4__) {
  ...
  JavaScriptCompiler.prototype = {
    ...
    invokeHelper: function(paramSize, name, isSimple, sexpr) {

      var nonHelper = this.popStack();
      var helper = this.setupHelper(paramSize, name, null, sexpr);
    ...
    invokeAmbiguous: function(name, helperCall, sexpr) {
      this.useRegister('helper');

      var nonHelper = this.popStack();

      this.emptyHash();
      var helper = this.setupHelper(0, name, helperCall, sexpr);
    ...
    setupHelper: function(paramSize, name, blockHelper, sexpr) {
      var params = [],
          paramsInit = this.setupHelperArgs(name, paramSize, params, blockHelper, sexpr);
    ...
    setupParams: function(helper, paramSize, params, other, sexpr) {
      ...
      if (sexpr && sexpr._crossbow) {
        options._crossbow = this.objectLiteral(sexpr._crossbow);
      }
      return options;
    },

    setupHelperArgs: function(helper, paramSize, params, useRegister, sexpr) {
      var options = this.setupParams(helper, paramSize, params, true, sexpr);
      options = this.objectLiteral(options);
      if (useRegister) {
